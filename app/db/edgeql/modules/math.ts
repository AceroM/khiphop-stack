...
function abs(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "c318b208-1506-11ed-8d57-fbed701dce1c", optional: false, setoftype: false, variadic: false}], returnTypeId: "c318b208-1506-11ed-8d57-fbed701dce1c"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
type var_cd984e32150611ed985637eee8681c30λFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
> = $.$expr_Function<
  "math::var",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
...
>;
type var_cd984e32150611ed985637eee8681c30λFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>,
> = $.$expr_Function<
  "math::var",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
 ...
 */
function var_cd984e32150611ed985637eee8681c30<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
>(
  vals: P1,
): var_cd984e32150611ed985637eee8681c30λFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
function var_cd984e32150611ed985637eee8681c30<
...
>(
  vals: P1,
): var_cd984e32150611ed985637eee8681c30λFuncExpr2<P1>;
function var_cd984e32150611ed985637eee8681c30(...args: any[]) {
...
type __defaultExports = {
  ...
  "var": typeof var_cd984e32150611ed985637eee8681c30;
...
const __defaultExports: __defaultExports = {
  ...
  "var": var_cd984e32150611ed985637eee8681c30,
  "var_pop": var_pop
};
